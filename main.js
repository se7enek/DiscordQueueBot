...
const prefix = "!";
const token = "NzY0NDUyNzEyMjIxNzY5NzM4.X4GeEQ.yOJUoI1t5ENtN61W4eo97HvWAqo";
...
client.on('message', async message => {
  if (message.content.startsWith(prefix) && message.content.endsWith("ping") && ready == true) {
    ...
    var embed = new Discord.MessageEmbed()
      .setTitle('<:auselfreport:763026312117747782> Kto chętny na grę w **Among Us**? <:auselfreport:763026312117747782>')
      .setColor(0xff0000)
